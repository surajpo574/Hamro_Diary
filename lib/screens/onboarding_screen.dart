...
import 'package:notepad_pro/utils/app_color.dart';
import 'package:notepad_pro/utils/image_path.dart';
                ...
                if (_currentIndex == onBoardinglist.length - 1) 
                {
                  ...
                  Navigator.push(
                    ...
                    if (_pageController1.positions.isNotEmpty &&
                         _pageController2.positions.isNotEmpty){
...
List<OnBoarding> onBoardinglist = [
  OnBoarding(
    ...
    description:
        '╰┈➤Our APP is OFFLINE and USER-FRIENDLY',
  ),
  OnBoarding(
      title: 'Dynamic and interactive experience',
      image: ImagesPath.kOnboarding2,
      description:
          'Engaging features to store notes , your Id & Password to remeber and Secure'),
  OnBoarding(
      title: "Can be accessed from anywhere at any time if its your own phone ;)",
      image: ImagesPath.kOnboarding3,
      description:
          'Updated and Bug free lets dive in the app quickly'),
];